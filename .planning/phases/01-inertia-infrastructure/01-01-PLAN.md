...
must_haves:
  ...
  artifacts:
    ...
    - path: "sgui/src/main.tsx"
      provides: "createInertiaApp setup with cookie-based CSRF config"
      contains: "createInertiaApp"
      contains_also: "xsrfCookieName"
...
- INRT-02: Base template has {% block inertia %} where InertiaMiddleware injects the Inertia root div. CSRF is cookie-based via Axios defaults (not meta tag — research found meta tags are an anti-pattern for Inertia+Django, see 01-RESEARCH.md)
